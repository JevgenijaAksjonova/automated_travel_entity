...
def image_callback(ros_image):
    try:
        ...
        global have_recieved_image
        have_recieved_image = True
...
# Get the depth image
def depth_callback(ros_depth):
    global depth_image
    depth_image = bridge.imgmsg_to_cv2(ros_depth)
...
def main():
    ...
    info_sub = rospy.Subscriber("/camera/rgb/camera_info",CameraInfo,info_callback)
